...
// DOM => Metodos seletores
// 1. getElementById

const inputAddTarefa = document.getElementById("inputadicionarTarefa");

// console.log(inputAddTarefa);
...
// elementoOndeVaiOElementoVaiSerInserido.appendChild(elementoASerInserido);

const main = document.querySelector('main');

// main.appendChild(meuH4);

// console.log(main)

// classList => adicionar e remover classes

const divFormulario = document.querySelector('.formularioTarefa');

divFormulario.classList.add('containerFormulario');

// console.log(divFormulario.classList);

divFormulario.classList.remove('containerFormulario');
...
// elemento.addEventListener('evento a ser interceptado', função a ser executada);

const buttonAdicionarTarefa = document.querySelector(".formularioTarefa button");

function imprimirNome(evento){
    console.log(evento);
}

buttonAdicionarTarefa.addEventListener('click', imprimirNome);